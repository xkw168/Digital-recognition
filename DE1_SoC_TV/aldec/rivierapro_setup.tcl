...
# ACDS 16.1 203 win32 2017.06.06.11:29:21
# ----------------------------------------
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "G:/intelfpga/16.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Sdram_Control_4Port/Sdram_PLL_sim/Sdram_PLL.vo"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/v/MAC_3_sim/MAC_3.v"                           
}
