...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Sdram_Control_4Port/Sdram_PLL_sim/Sdram_PLL.vo"
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/v/MAC_3_sim/MAC_3.v"                           
fi
