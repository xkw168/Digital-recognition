...
# ----------------------------------------
# ACDS 16.1 203 win32 2017.06.06.11:29:20
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Sdram_Control_4Port/Sdram_PLL_sim/Sdram_PLL.vo"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/v/MAC_3_sim/MAC_3.v"                           
}
