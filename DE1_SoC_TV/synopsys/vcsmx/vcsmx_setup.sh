...
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="G:/intelfpga/16.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Sdram_Control_4Port/Sdram_PLL_sim/Sdram_PLL.vo"
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/v/MAC_3_sim/MAC_3.v"                           
fi
